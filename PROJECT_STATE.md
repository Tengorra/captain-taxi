...
- [ ] Driver Profile / Edit page: surface the new fields from session 8 (attributes, fatigue, VAT, sites, files) on the existing `DriverProfile.tsx` so they're editable after creation
