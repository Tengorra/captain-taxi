...
- [x] Mandatory-field rules for manual Add-Driver form now read from Settings.driver_mandatory_fields (a follow-up UI editor in Settings.tsx is still nice-to-have but the rule is no longer hard-coded)
